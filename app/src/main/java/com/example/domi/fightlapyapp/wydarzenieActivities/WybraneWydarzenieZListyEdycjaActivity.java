...
public class WybraneWydarzenieZListyEdycjaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        godzina = (TextView) findViewById(R.id.godzina_edycja);
        data = (TextView) findViewById(R.id.data_edycja);

        Intent i = getIntent();
        product = i.getStringExtra("wydarzenie");
        Wydarzenie wybraneWydarzenie=wyszukanieDanychWydarzenia(product);

        miejsceET.setText(wybraneWydarzenie.getMiejsce());
        ...
        opisET.setText(wybraneWydarzenie.getOpis());

        Integer typWydarzenia = wybraneWydarzenie.getIdTypuWydarzenia();

        typWydarzeniaSpinner.setSelection(typWydarzenia-1);
        data.setText(wybraneWydarzenie.getData());
        godzina.setText(wybraneWydarzenie.getGodzina());
...
/*
        ...
        Log.i("Godzina ",wybraneWydarzenie.getGodzina());
        //godzina.setText("Godzina");
*/
    ...
    private void zapisEdytowanegoWydarzenia(View v){
        ...
        String dataWydarzeniaNew= data.getText().toString();
        ...
        String godzineWydarzeniaNew= godzina.getText().toString();
        ...
        Intent intent = new Intent(this, UdanaEdycjaWydarzeniaActivity.class);
